							...
							<ul class="nav navbar-nav">
								...
								<li>
									<a href="{{ url('yourCart') }}">
										...
										<span id="cart-quantity">{{ session()->has('cart') ? collect(session('cart'))->sum('qty') : 0 }}</span>
									</a>
								</li>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="{{ url('member/account/product') }}">Products</a></li>
								...
								<li class="dropdown"><a href="{{url ('member/blog')}}">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="{{url ('member/blog')}}">Blog List</a></li>
